...
{	
	...
	public class InputManager : MonoBehaviour
	{
		...
		protected virtual void HandleKeyboardForPlayer(int number, IActorInput p) 
		{
			...
			HorizontalPosition(p, Input.GetAxis("Horizontal"));
			VerticalPosition(p, Input.GetAxis("Vertical"));
			...
			if (Input.GetKey(KeyCode.Space)) { MainActionButtonPressed(p); }
			if (Input.GetKeyDown(KeyCode.Space)) { MainActionButtonDown(p); }
			if (Input.GetKeyUp(KeyCode.Space)) { MainActionButtonReleased(p); }
			...
			// if (Input.GetKey(KeyCode.LeftShift)) { AltActionButtonPressed(p); }
			// if (Input.GetKeyDown(KeyCode.LeftShift)) { AltActionButtonDown(p); }
			// if (Input.GetKeyUp(KeyCode.LeftShift)) { AltActionButtonReleased(p); }
			...
			if (Input.GetKey(KeyCode.R)) { RespawnActionButtonPressed(p); }
			if (Input.GetKey(KeyCode.R)) { RespawnActionButtonDown(p); }
			if (Input.GetKey(KeyCode.R)) { RespawnActionButtonReleased(p); }
		}
