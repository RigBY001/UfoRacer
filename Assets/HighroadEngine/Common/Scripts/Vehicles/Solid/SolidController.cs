...
namespace MoreMountains.HighroadEngine
{
	...
	public class SolidController : BaseController 
	{
		...
		public float EngineForceWithBoost{get{ return EngineForce * _player.GetTotalSpeedMultiplier();}}
		...
		{	
			...
			CurrentEngineForceValue = (Quaternion.AngleAxis(90, transform.right) * _hit.normal * (EngineForceWithBoost * gasPedalForce));

		}
		protected virtual void UpdateEngineForceValueOld()
		{
