...
namespace TDSTK{
	...
	public class SpawnerEditor : TDSEditorInspector {
		...
		public override void OnInspectorGUI(){
			...
			cont=new GUIContent("Spawn Around Player:", "Spawn Enempy Around Player");
			EditorGUILayout.PropertyField(serializedObject.FindProperty ("spawnAroundPlayer"), cont);
			...
			cont=new GUIContent("Range:", "Spawn range");
			EditorGUILayout.PropertyField(serializedObject.FindProperty ("range"), cont);
