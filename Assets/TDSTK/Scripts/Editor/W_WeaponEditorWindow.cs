...
namespace TDSTK {
	...
	public class WeaponEditorWindow : TDSEditorWindow {
		...
		Vector2 DrawWeaponConfigurator(float startX, float startY, Weapon weapon){
			...
			cont=new GUIContent("Shop Cost:", "The shop cost the ability");
			EditorGUI.LabelField(new Rect(startX, startY+=spaceY, width, height), cont);
			weapon.ShopCost=EditorGUI.DelayedIntField(new Rect(startX+spaceX, startY, 40, height), weapon.ShopCost);
			...
			EditorGUI.LabelField(new Rect(startX, startY+=spaceY, width, height), cont);
			if(!weapon.useEnergyAsAmmo) EditorGUI.LabelField(new Rect(startX+spaceX, startY, 40, height), "-");
			else weapon.energyCost=EditorGUI.DelayedFloatField(new Rect(startX+spaceX, startY, 40, height), weapon.energyCost);
			...
			EditorGUI.LabelField(new Rect(startX, startY+=spaceY, width, height), cont);
			if(weapon.useEnergyAsAmmo) EditorGUI.LabelField(new Rect(startX+spaceX, startY, 40, height), "-");
			else weapon.clipSize=EditorGUI.DelayedIntField(new Rect(startX+spaceX, startY, 40, height), weapon.clipSize);
			...
			EditorGUI.LabelField(new Rect(startX, startY+=spaceY, width, height), cont);
			if(weapon.useEnergyAsAmmo) EditorGUI.LabelField(new Rect(startX+spaceX, startY, 40, height), "-");
			else weapon.ammoCap=EditorGUI.DelayedIntField(new Rect(startX+spaceX, startY, 40, height), weapon.ammoCap);
			
			cont=new GUIContent("Reload Duration:", "The duration in seconds to reload the weapon");
			EditorGUI.LabelField(new Rect(startX, startY+=spaceY, width, height), cont);
			if(weapon.useEnergyAsAmmo) EditorGUI.LabelField(new Rect(startX+spaceX, startY, 40, height), "-");
			else weapon.reloadDuration=EditorGUI.DelayedFloatField(new Rect(startX+spaceX, startY, 40, height), weapon.reloadDuration);
